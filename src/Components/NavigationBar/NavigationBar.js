...
function NavigationBar() {
  const { chooseComponent, setChooseComponent, bookNow, setBookNow } =
      ...
      <BrowserRouter>
        <div className="navigation_bar_container">
          <nav className="navigation_bar">
            <ul>
              <li>
                <div className="navigation_hamburger_menu">
                  <GiHamburgerMenu
                    onClick={() => setBurgerBarActivation(true)}
                  />
                </div>
              </li>
              <li>
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("home");
                    setBookNow(false);
                    setChooseComponent(null);
                  }}
                  id={navBarActivation === "home" ? "navBarActivation" : null}
                  to="/"
                >
                  Home
                </Link>
              ...
              <li>
                ...
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("about");
                    setBookNow(false);
                  }}
                  id={navBarActivation === "about" ? "navBarActivation" : null}
                  to="/aboutHotel"
                >
                  About Hotel
                </Link>
              ...
              <li>
                ...
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("gallery");
                    setBookNow(false);
                  }}
                  id={
                    navBarActivation === "gallery" ? "navBarActivation" : null
                  }
                  to="/gallery"
                >
                  Gallery
              ...
              <li>
                ...
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("rooms");
                    setBookNow(false);
                  }}
                  id={navBarActivation === "rooms" ? "navBarActivation" : null}
                  to="/rooms"
                >
                  Rooms
                </Link>
              ...
              <li>
                ...
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("restaurant");
                    setBookNow(false);
                  }}
                  id={
                    navBarActivation === "restaurant"
                      ? "navBarActivation"
                      : null
                  }
                  to="/restaurants"
              ...
              <li>
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("events");
                    setBookNow(false);
                  }}
                  id={navBarActivation === "events" ? "navBarActivation" : null}
                  to="/events"
                >
                  Events
                </Link>
              ...
              <li>
                ...
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("facilities");
                    setBookNow(false);
                  }}
                  id={
                    navBarActivation === "facilities"
                      ? "navBarActivation"
                      : null
                  }
                  to="/facilities"
              ...
              <li>
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("services");
                    setBookNow(false);
                  }}
                  id={
                    navBarActivation === "services" ? "navBarActivation" : null
                  }
                  to="/services"
                >
                  Services
              ...
              <li>
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("specialDeal");
                    setBookNow(false);
                  }}
                  id={
                    navBarActivation === "specialDeal"
                      ? "navBarActivation"
                      : null
                  }
                  to="/specialDeals"
              ...
              <li>
                <Link
                  className="listItem"
                  onClick={() => {
                    setNavBarActivation("contact");
                    setBookNow(false);
                  }}
                  id={
                    navBarActivation === "contact" ? "navBarActivation" : null
                  }
                  to="contacts"
                >
                  Contacts
              ...
              <li>
                ...
                <button
                  ...
                  className="navigation_bookNow_btn"
                >
                  Book Now
                </button>
              </li>
        ...
        {burgerBarActivation ? (
          <>
            ...
            <div className="hamburger_menu">
              <VscChromeClose
                onClick={() => setBurgerBarActivation(false)}
                    ...
                    <li>
                      <Link
                        ...
                        onClick={() => {
                          ...
                          setBookNow(false);
                          setChooseComponent(null);
                          setBurgerBarActivation(false);
                        }}
                        id={
                          navBarActivation === "home"
                            ? "navBarActivation"
                            : null
                        }
                        to="/"
