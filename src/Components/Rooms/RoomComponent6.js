...
function RoomComponent6({setGuessComponent,setBookNow}) {
  const roomImages = [RoomStandardImg1, RoomStandardImg2, RoomStandardImg3,RoomStandardImg1, RoomStandardImg2, RoomStandardImg3];
  ...
  return (
    <div className="roomComponent">
      ...
      <p className="room_component_title">Excutive Suite</p>
