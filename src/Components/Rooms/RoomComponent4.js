...
function RoomComponent4({setGuessComponent,setBookNow}) {
  const roomImages = [RoomStandardImg1, RoomStandardImg2, RoomStandardImg3];
  ...
  return (
    <div className="roomComponent">
      ...
      <p className="room_component_title">Premium Superior</p>
